...
gsap.from(".title__responsibility", {
    scrollTrigger: {
        trigger: ".responsibility",
        start: "top 40%",
        // markers: true,
...
gsap.from(".subtitle__responsibility", {
    scrollTrigger: {
        trigger: ".responsibility",
        start: "top 10%",
        // markers: true,
...
// Scroll animation offer
gsap.from(".executive_contacts", {
    scrollTrigger: {
        trigger: ".wrapper__executive",
        start: "top 20%",
        // markers: true,
        end: "+=50px",
    },
